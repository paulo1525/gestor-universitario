...
export type PlacementMove={originClass?:number;destinationClass:number;rank:number|null;status:string;manualOverride?:boolean};
...
export function placementOrigin(student:PlacementStudent,move?:PlacementMove):number;
