...
import { AlertCircle, Bell, BookOpen, CalendarDays, ChevronRight, ClipboardCheck, FileHeart, Inbox, LayoutDashboard, LoaderCircle, Megaphone, RefreshCw, Star, Vote } from "lucide-react";
...
type DashboardData = { events: Entry[]; announcements: Entry[]; polls: Entry[]; requests: Entry[]; materials: Entry[]; unread: number };
