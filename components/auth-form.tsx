  ...
  return (
    <>
      ...
      <form className="auth-form" onSubmit={submit}>
        ...
        <label className="remember-login"><input type="checkbox" checked={rememberMe} onChange={(event) => { setRememberMe(event.target.checked); localStorage.setItem("gu_persistent_login", String(event.target.checked)); }} /><span><strong>Manter sessão iniciada</strong><small>Recomendado num dispositivo pessoal: mantém o acesso durante 7 dias.</small></span></label>
