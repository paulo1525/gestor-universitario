  ...
  return <div className="app-shell">
    ...
    <aside className={`sidebar ${open ? "sidebar--open" : ""}`}>
      ...
      <nav className="nav-list" aria-label="Navegação principal">
        <div className="nav-section"><span className="nav-label">Comunicação</span>
        ...
        <div className="nav-section"><span className="nav-label">Vida académica</span>
        ...
        <div className="nav-section"><span className="nav-label">Comunidade</span>
