          ...
          <div className={adminNavigationStyles.groups}>
            ...
            {hasAcademicLife&&<section className={adminNavigationStyles.group}>
              ...
              <div id="site-navigation-academic" className={`${adminNavigationStyles.groupItems} ${openSiteGroup !== "academic" ? adminNavigationStyles.groupItemsClosed : ""}`}>
                ...
                {(moduleAccess["materials.library"]||moduleAccess["materials.submission"])&&<div className={adminNavigationStyles.itemWithAction}><Link className={`${adminNavigationStyles.item} ${active === "materials" ? adminNavigationStyles.active : ""}`} href="/materiais" onClick={() => setOpen(false)}><Library/><span>{t("nav.materials.title")}</span></Link><a className={adminNavigationStyles.itemAction} href="/materiais-do-ano/" target="_blank" rel="noopener" onClick={() => setOpen(false)} aria-label={t("nav.materials.public")} title={t("nav.materials.public")}><ExternalLink aria-hidden="true"/></a></div>}
