...
export function TurmasDashboard(){
 const router=useRouter(),[classes,setClasses]=useState<Turma[]>([]),[search,setSearch]=useState(""),[loading,setLoading]=useState(true);
 ...
 <section className="stats-grid"><article className="stat-card"><span className="stat-card__icon stat-card__icon--ink"><Users/></span><div><span>Alunos registados</span><strong>{total}</strong><small>nas 20 turmas</small></div></article><article className="stat-card"><span className="stat-card__icon stat-card__icon--blue"><Building2/></span><div><span>Turmas criadas</span><strong>20</strong><small>todas disponíveis</small></div></article><article className="stat-card"><span className="stat-card__icon stat-card__icon--green"><CheckCircle2/></span><div><span>Submetidas</span><strong>{submitted}/20</strong><small>listas entregues</small></div></article></section>
